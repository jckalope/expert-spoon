...
'''python "C:\Users\12joc\bcq_tensorflow\train_expert.py" --env_name LunarLanderContinuous-v2 --seed 31 --expl_noise=0.1 --actor_lr=0.0005 --critic_lr=0.0005 --actor_hs=64 --critic_hs=64 --batch_size=32 --discount=0.99 --tau=0.001
'''


if __name__ == "__main__":
	
	parser = argparse.ArgumentParser() #j taking in arguments from command line 
