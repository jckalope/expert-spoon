...
if __name__ == "__main__":
	...
	with tf.compat.v1.Session() as sess:
		...
		while training_iters < args.max_timesteps:
			...
			print("Training iterations: " + str(training_iters) + ", stop at "+str(args.max_timesteps))
			#print(stats_loss)
			print("total time:", time.time() - start)
			print("last time:", time.time() - last_iter)
			last_iter = time.time()

		# Save final policy

		policy.save("%s" % (file_name), directory="./models1.h5")

		checkpoint = tf.train.Checkpoint(model=policy)
		checkpoint_path = r'C:\Users\12joc\models1.ckpt'
		checkpoint.restore(checkpoint_path).expect_partial()
		

		saved_model_path = r'C:\Users\12joc\savedModel'
		tf.saved_model.save(model, saved_model_path)
		# tf.saved_model.save("./models2")
		# policy.save2(directory="./models2")
		#tf.saved_model.save(policy, "./models/save1")